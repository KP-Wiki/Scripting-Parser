...
| 13900 | <a id="ClosestGroupEx">ClosestGroupEx</a><sub><br/>Returns the group of the specified player and group type that is closest to the specified coordinates,<br/>or -1 if no such group was found.</sub> | <sub>**aHand**: Integer; <br/> **X**: Integer; <br/> **Y**: Integer; <br/> **aGroupType**: TKMGroupType;</sub> | <sub>Integer // Group ID</sub> |
...
| 13900 | <a id="ClosestUnitMultipleTypesEx">ClosestUnitMultipleTypesEx</a><sub><br/>Returns the unit of the specified player and unit types that is closest to the specified coordinates,<br/>or -1 if no such unit was found.<br/>The unit types is a "set of TKMUnitType", for example [utSerf, utMilitia]</sub> | <sub>**aHand**: Integer; <br/> **X**: Integer; <br/> **Y**: Integer; <br/> **aUnitTypes**: TKMUnitTypeSet; // _Set of unit types_</sub> | <sub>Integer // Unit ID</sub> |
...
| 13900 | <a id="MapTilePassabilityEx">MapTilePassabilityEx</a><sub><br/>Returns true if specified tile has requested passability.</sub> | <sub>**X**: Integer; <br/> **Y**: Integer; <br/> **aPassability**: TKMTerrainPassability; // _TKMTerrainPassability_</sub> | <sub>Boolean // True or False</sub> |
