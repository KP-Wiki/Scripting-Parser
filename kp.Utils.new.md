...
| 15066 | <a id="ArrayAppend">ArrayAppend</a><sub><br/>Appends value to specified TKMStringArray.</sub> | <sub>**var aArray**: TKMStringArray; <br/> **aValue**: string;</sub> | <sub></sub> |
| 15066 | <a id="ArrayAppendI">ArrayAppendI</a><sub><br/>Appends value to specified TKMIntegerArray.</sub> | <sub>**var aArray**: TKMIntegerArray; <br/> **aValue**: Integer;</sub> | <sub></sub> |
| 15066 | <a id="ArrayAppendS">ArrayAppendS</a><sub><br/>Appends value to specified TKMSingleArray.</sub> | <sub>**var aArray**: TKMSingleArray; <br/> **aValue**: Single;</sub> | <sub></sub> |
...
| 15136 | <a id="ArrayElementCount">ArrayElementCount</a><sub><br/>Checks how many times specified string comes in requested array</sub> | <sub>**aArray**: TKMStringArray; <br/> **aElement**: string;</sub> | <sub>Integer</sub> |
...
| 15136 | <a id="ArrayElementCountI">ArrayElementCountI</a><sub><br/>Checks how many times specified integer comes in requested array</sub> | <sub>**aArray**: TKMIntegerArray; <br/> **aElement**: Integer;</sub> | <sub>Integer</sub> |
...
| 15136 | <a id="ArrayElementCountS">ArrayElementCountS</a><sub><br/>Checks how many times specified single comes in requested array</sub> | <sub>**aArray**: TKMSingleArray; <br/> **aElement**: Single;</sub> | <sub>Integer</sub> |
| 15136 | <a id="ArrayFindMaxI">ArrayFindMaxI</a><sub><br/>Returns max number of array elements</sub> | <sub>**aArray**: TKMIntegerArray;</sub> | <sub>Integer</sub> |
| 15136 | <a id="ArrayFindMaxS">ArrayFindMaxS</a><sub><br/>Returns max number of array elements</sub> | <sub>**aArray**: TKMSingleArray;</sub> | <sub>Single</sub> |
| 15136 | <a id="ArrayFindMinI">ArrayFindMinI</a><sub><br/>Returns min number of array elements</sub> | <sub>**aArray**: TKMIntegerArray;</sub> | <sub>Integer</sub> |
| 15136 | <a id="ArrayFindMinS">ArrayFindMinS</a><sub><br/>Returns min number of array elements</sub> | <sub>**aArray**: TKMSingleArray;</sub> | <sub>Single</sub> |
...
| 15136 | <a id="ArrayHasElement">ArrayHasElement</a><sub><br/>Checks whether requested array has specified string</sub> | <sub>**aArray**: TKMStringArray; <br/> **aElement**: string;</sub> | <sub>Boolean</sub> |
...
| 15136 | <a id="ArrayHasElementI">ArrayHasElementI</a><sub><br/>Checks whether requested array has specified integer</sub> | <sub>**aArray**: TKMIntegerArray; <br/> **aElement**: Integer;</sub> | <sub>Boolean</sub> |
...
| 15136 | <a id="ArrayHasElementS">ArrayHasElementS</a><sub><br/>Checks whether requested array has specified single number</sub> | <sub>**aArray**: TKMSingleArray; <br/> **aElement**: Single;</sub> | <sub>Boolean</sub> |
| 15136 | <a id="ArraySumI">ArraySumI</a><sub><br/>Returns sum of the elements of requested array</sub> | <sub>**aArray**: TKMIntegerArray;</sub> | <sub>Integer</sub> |
| 15136 | <a id="ArraySumS">ArraySumS</a><sub><br/>Returns sum of the elements of requested array</sub> | <sub>**aArray**: TKMSingleArray;</sub> | <sub>Single</sub> |
