...
| 7000+ | <a id="AIAttackRemove">AIAttackRemove</a><sub><br/>Remove AI attack by attack UID</sub> | <sub>**aHand**: Integer; <br/> **aAIAttackUID**: Integer;</sub> | <sub>Boolean // True, if attack was successfully removed, False, if attack was not found</sub> |
...
| 15000 | <a id="GiveFish">GiveFish</a><sub><br/>Adds fish to a specified position with aCount fish available to catch<br/>aCount should be in the range 1 to 255<br/>Returns the unit ID or -1 if the fish was not able to be added</sub> | <sub>**X, Y**: Integer; <br/> **aCount**: Integer;</sub> | <sub>Integer</sub> |
...
| 6277 | <a id="GroupBlockOrders">GroupBlockOrders</a><sub><br/>Disables (Disable = True) or enables (Disable = False) control over specified warriors group</sub> | <sub>**aGroupID**: Integer; <br/> **aBlock**: Boolean;</sub> | <sub>-</sub> |
...
| 5057 | <a id="GroupOrderSplit">GroupOrderSplit</a><sub><br/>Order the specified group to split in half.<br/>Return the newly created group ID or -1 if splitting failed (e.g. only 1 member)</sub> | <sub>**aGroupID**: Integer;</sub> | <sub>Integer</sub> |
| 6338 | <a id="GroupOrderSplitUnit">GroupOrderSplitUnit</a><sub><br/>Splits specified unit from the group.<br/>Returns the newly created group ID or -1 if splitting failed (e.g. only 1 member)</sub> | <sub>**aGroupID**: Integer; <br/> **aUnitID**: Integer;</sub> | <sub>Integer</sub> |
...
| 14000 | <a id="HouseBarracksGiveRecruits">HouseBarracksGiveRecruits</a><sub><br/>Adds aCount recruits to the specified barracks</sub> | <sub>**aHouseID**: Integer; <br/> **aCount**: Integer;</sub> | <sub>-</sub> |
...
| 7000+ | <a id="HouseTownHallMaxGold">HouseTownHallMaxGold</a><sub><br/>Set TownHall Max Gold parameter (how much gold could be delivered to it)</sub> | <sub>**aHouseID**: Integer; <br/> **aMaxGold**: Integer;</sub> | <sub>-</sub> |
...
| 15000 | <a id="UnitFishCountSet">UnitFishCountSet</a><sub><br/>Sets the number of fish available to catch for the fish unit with the specified aUnitID<br/>aCount should be in range of 0 to 255. If aCount is set to 0, the fish unit will be instantly killed</sub> | <sub>**aUnitID**: Integer; <br/> **aCount**: Integer;</sub> | <sub>-</sub> |
...
| 7000+ | <a id="UnitHPSetInvulnerable">UnitHPSetInvulnerable</a><sub><br/>Makes the unit invulnerable. Such unit cannot be killed or die from hunger.</sub> | <sub>**aUnitID**: Integer; <br/> **aInvulnerable**: Boolean;</sub> | <sub>-</sub> |
