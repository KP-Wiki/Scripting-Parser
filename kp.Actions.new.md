...
| - | <a id="GiveUnit">GiveUnit</a><sub><br/>Gives unit to a player<br/>Should be a citizen unit. For warriors - use GiveGroup</sub> | <sub>**aPlayer**: Integer; <br/> **aUnitType**: TKMUnitType; <br/> **X, Y**: Word; <br/> **aDir**: Word;</sub> | <sub>Integer // UID of the unit on success</sub> |
