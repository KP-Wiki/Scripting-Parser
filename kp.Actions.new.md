...
| 8461 | <a id="FenceAdd">FenceAdd</a><sub><br/>Set a fence on terrain</sub> | <sub>**X**: Word; <br/> **Y**: Word; <br/> **aDir**: Word; <br/> **aFenceType**: TKMFenceType; // _Type of the fence_ <br/> **aPlayer**: Integer; // _Owner of the fence_</sub> | <sub>Boolean // Success or fail</sub> |
