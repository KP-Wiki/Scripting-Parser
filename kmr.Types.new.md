...
| - | <a id="TByteSet">TByteSet</a><sub><br/>Array of bytes</sub> | <sub>**set of Byte;**</sub>
...
| - | <a id="TReplaceFlags">TReplaceFlags</a><sub><br/>Flags for string replacement operations</sub> | <sub>**rfReplaceAll**</sub><br/><sub>**rfIgnoreCase**</sub>
