...
| ------- | ------------------------------------ | -------------- |
| 6570 | <a id="OnBeacon">OnBeacon</a><sub><br/>Occurs when a player places a beacon on the map.</sub> | <sub>**aPlayer**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer;</sub> |
| 7000+ | <a id="OnFieldBuilt">OnFieldBuilt</a><sub><br/>Occurs when player built a field.</sub> | <sub>**aPlayer**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer;</sub> |
| 11000 | <a id="OnGameSpeedChanged">OnGameSpeedChanged</a><sub><br/>Occurs when game speed was changed</sub> | <sub>**aSpeed**: Single;</sub> |
| 11200 | <a id="OnGroupBeforeOrderSplit">OnGroupBeforeOrderSplit</a><sub><br/>Occurs right before the group gets order to split.<br/>Split parameters could be altered by script and returned to the game to be used there<br/>aNewType: new group leader unit type<br/>aNewCnt: new group members count<br/>aMixed: is new group can have the only unit type or it can have any unit type from original group</sub> | <sub>**aGroup**: Integer; //_group ID, which got split order_ <br/> **var aNewType**: TKMUnitType; <br/> **var aNewCnt**: Integer; <br/> **var aMixed**: Boolean;</sub> |
...
| 7000+ | <a id="OnGroupOrderMove">OnGroupOrderMove</a><sub><br/>Occurs when the group gets order to move to some point</sub> | <sub>**aGroup**: Integer; //_group ID_ <br/> **aX**: Integer; //_Point coordinates_ <br/> **aY**: Integer;</sub> |
...
| 6114 | <a id="OnHouseAfterDestroyed">OnHouseAfterDestroyed</a><sub><br/>Occurs after a house is destroyed and has been completely removed from the game,<br/>meaning the area it previously occupied can be used.<br/>If you need more information about the house use the OnHouseDestroyed event.</sub> | <sub>**aHouseType**: Integer; //_HouseType as Integer from Lookup table_ <br/> **aOwner**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer;</sub> |
| 14000 | <a id="OnHouseAfterDestroyedEx">OnHouseAfterDestroyedEx</a><sub><br/>Occurs after a house is destroyed and has been completely removed from the game,<br/>meaning the area it previously occupied can be used.<br/>If you need more information about the house use the OnHouseDestroyed event.</sub> | <sub>**aHouseType**: TKMHouseType; //_HouseType as TKMHouseType_ <br/> **aOwner**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer;</sub> |
...
| 5871 | <a id="OnHousePlanPlaced">OnHousePlanPlaced</a><sub><br/>Occurs when player has placed a house plan.</sub> | <sub>**aPlayer**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer; <br/> **aHouseType**: Integer; //_HouseType as Integer from Lookup table_</sub> |
| 14000 | <a id="OnHousePlanPlacedEx">OnHousePlanPlacedEx</a><sub><br/>Occurs when player has placed a house plan.</sub> | <sub>**aPlayer**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer; <br/> **aHouseType**: TKMHouseType; //_HouseType as TKMHouseType_</sub> |
| 6298 | <a id="OnHousePlanRemoved">OnHousePlanRemoved</a><sub><br/>Occurs when player has removed a house plan.</sub> | <sub>**aPlayer**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer; <br/> **aHouseType**: Integer; //_HouseType as Integer from Lookup table_</sub> |
| 14000 | <a id="OnHousePlanRemovedEx">OnHousePlanRemovedEx</a><sub><br/>Occurs when player has removed a house plan.</sub> | <sub>**aPlayer**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer; <br/> **aHouseType**: TKMHouseType; //_HouseType as TKMHouseType_</sub> |
...
| 6216 | <a id="OnMarketTrade">OnMarketTrade</a><sub><br/>Occurs when a trade happens in a market (at the moment when resources are exchanged by serfs).</sub> | <sub>**aMarket**: Integer; <br/> **aFrom**: Integer; //_From, aTo as Integer from Lookup table_ <br/> **aTo**: Integer;</sub> |
| 14000 | <a id="OnMarketTradeEx">OnMarketTradeEx</a><sub><br/>Occurs when a trade happens in a market (at the moment when resources are exchanged by serfs).</sub> | <sub>**aMarket**: Integer; <br/> **aFrom**: TKMWareType; //_From, aTo as TKMWareType_ <br/> **aTo**: TKMWareType;</sub> |
...
| 5964 | <a id="OnPlanFieldPlaced">OnPlanFieldPlaced</a><sub><br/>Occurs when player has placed a field plan.</sub> | <sub>**aPlayer**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer;</sub> |
| 6301 | <a id="OnPlanFieldRemoved">OnPlanFieldRemoved</a><sub><br/>Occurs when player has removed a field plan.</sub> | <sub>**aPlayer**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer;</sub> |
| 7000+ | <a id="OnPlanRoadDigged">OnPlanRoadDigged</a><sub><br/>Occurs when road plan is digged.</sub> | <sub>**aPlayer**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer;</sub> |
| 5964 | <a id="OnPlanRoadPlaced">OnPlanRoadPlaced</a><sub><br/>Occurs when player has placed a road plan.</sub> | <sub>**aPlayer**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer;</sub> |
| 6301 | <a id="OnPlanRoadRemoved">OnPlanRoadRemoved</a><sub><br/>Occurs when player has removed a road plan.</sub> | <sub>**aPlayer**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer;</sub> |
| 7000+ | <a id="OnPlanWinefieldDigged">OnPlanWinefieldDigged</a><sub><br/>Occurs when winefield is digged</sub> | <sub>**aPlayer**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer;</sub> |
| 5964 | <a id="OnPlanWinefieldPlaced">OnPlanWinefieldPlaced</a><sub><br/>Occurs when player has placed a wine field plan.</sub> | <sub>**aPlayer**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer;</sub> |
| 6301 | <a id="OnPlanWinefieldRemoved">OnPlanWinefieldRemoved</a><sub><br/>Occurs when player has removed a wine field plan.</sub> | <sub>**aPlayer**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer;</sub> |
...
| 7000+ | <a id="OnWinefieldBuilt">OnWinefieldBuilt</a><sub><br/>Occurs when player built a winefield.</sub> | <sub>**aPlayer**: Integer; <br/> **aX**: Integer; <br/> **aY**: Integer;</sub> |
